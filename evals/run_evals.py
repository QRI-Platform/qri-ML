...
from evals.config import OrchastratorEvalConfig,GeneratorEvalConfig
from evals.config import RetreiverEvalConfig
...
if __name__ == "__main__":
    # asyncio.run(evaluating_retreiver())
    asyncio.run(asyncio.gather(evaluating_orchastrator(),
